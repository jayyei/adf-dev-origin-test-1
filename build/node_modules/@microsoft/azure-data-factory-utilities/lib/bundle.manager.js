...
var BundleManager = /** @class */ (function () {
    function BundleManager(_bundleUrl, _nodeOptions, _preview) {
    ...
    BundleManager.prototype.invokeBundle = function (args) {
        ...
        https.get(this._bundleUrl, function (response) {
            ...
            file.on('finish', function () {
                ...
                if (_this._preview) {
                    utils_1.printToConsole("Using the option: " + _this._preview);
                }
                utils_1.printToConsole("Inserting the following arguments: " + argsToInsert);
                var execCommand = ['node', _this._nodeOptions, escapedBundleFilePath, argsToInsert, _this._preview].join(' ');
